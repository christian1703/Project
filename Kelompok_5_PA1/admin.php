...
<div class="container-fluid admin">
    <div class="row">
        ...
        <div class="col right-side ">
            <h3 class="mt-4 ml-4"><span class="fa fa-plus mr-2"></span> Menambah barang</h3>
            <hr class="">
        <div class="col-lg-8 mx-auto mt-5 bg-white p-5 border shadow-sm">
            <form action="proses-tambah-barang.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="exampleInputEmail1">Nama barang</label>
                    <input type="text" class="form-control" placeholder="Nama barang" name="nama_sparepart">
                </div>
                <div class="form-group">
